...
<%--					<a href="${pageContext.request.contextPath}/dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增客户基础信息</a>--%>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a class="addVersion" href="${pageContext.request.contextPath}/user/all/selectUser?uid=${users.uid}"  data-toggle="tooltip" data-placement="top" title="" data-original-title="修改信息">修改信息</a>
						<li><a class="addVersion" href="${pageContext.request.contextPath}/user/all/skpiupdateuser?rid=${users.rid}"  data-toggle="tooltip" data-placement="top" title="" data-original-title="添加入住客户">添加入住客户</a>
						</li>
