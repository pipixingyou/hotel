...
<%--										<td>${appInfo.versionNo }</td>--%>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a class="addVersion" href="finishRoom?rid=${rooms.rid}&typeid=${rooms.typeid}" data-toggle="tooltip" data-placement="top" title="" data-original-title="维修完毕">维修完毕</a>
                        </li>
						...
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
									<li class="paginate_button previous"><a
										href="${pageContext.request.contextPath}/manager/backend/app/fixRoom?pageNum=${pageInfo.navigateFirstPage}"
										aria-controls="datatable-responsive" data-dt-idx="0"
										tabindex="0">首页</a>
									</li>
									<li class="paginate_button "><a
										href="${pageContext.request.contextPath}/manager/backend/app/fixRoom?pageNum=${pageInfo.prePage}"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
									<li class="paginate_button "><a
										href="${pageContext.request.contextPath}/manager/backend/app/fixRoom?pageNum=${pageInfo.nextPage}"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									</li>
									<li class="paginate_button next"><a
										href="${pageContext.request.contextPath}/manager/backend/app/fixRoom?pageNum=${pageInfo.navigateLastPage}"
