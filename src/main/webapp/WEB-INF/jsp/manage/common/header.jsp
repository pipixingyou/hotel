        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="http://www.zentravel.cn/hotel/136" class="site_title"><i class="fa fa-paw"></i> <span>帆船酒店</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> 客房信息管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/manager/backend/app/list">可入住房间</a></li>
                      <li><a href="${pageContext.request.contextPath }/manager/backend/app/fulllist">已入住房间</a></li>
                      <li><a href="${pageContext.request.contextPath }/manager/backend/app/fixRoom">维修中房间</a></li>
                      <li><a href="${pageContext.request.contextPath }/manager/backend/app/ingRoom">预定房间</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 用户信息管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath}/user/all/userlist">入住信息</a></li>
                      <li><a href="${pageContext.request.contextPath}/user/all/nullUserList">历史信息</a></li>
                      <li><a href="${pageContext.request.contextPath}/user/all/ingUserList">预定信息</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${pageContext.request.contextPath }/statics/images/img.jpg" alt="">${manage.mcode }
