...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form action="ingUserList" id="myForm">
...
<%--										<td>${users.totime}</td>--%>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a class="addVersion" href="${pageContext.request.contextPath}/user/all/selectUser?uid=${users.uid}" data-toggle="tooltip" data-placement="top"  data-original-title="修改信息">修改信息</a>
                        </li>
