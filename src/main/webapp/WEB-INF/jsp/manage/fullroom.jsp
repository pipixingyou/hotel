...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form action="fulllist" id="myForm">
...
<%--								<select name="queryStatus" class="form-control">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">房间号</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
...
<%--										<td>${appInfo.versionNo }</td>--%>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a  href="${pageContext.request.contextPath}/manager/backend/app/checkOutRoom?rid=${rooms.rid}" data-toggle="tooltip" data-placement="top" title="" data-original-title="退房">退房</a>
                        </li>
<%--                        <li><a  href="appinfoadd?rid=${rooms.rid}&typeid=${rooms.typeid}"
											data-toggle="tooltip" data-placement="top"  >添加用户</a>
                        </li>
                        <li><a appinfoid="${appInfo.id }" status="${appInfo.status }" statusname="${appInfo.statusName }"
											data-toggle="tooltip" data-placement="top" title="" data-original-title="修改APP基础信息">修改</a></li>
                        <li><a   appinfoid=${appInfo.id }  data-toggle="tooltip" data-placement="top" title="" data-original-title="查看APP基础信息以及全部版本信息">查看</a></li>
						<li><a   appinfoid=${appInfo.id }  appsoftwarename=${appInfo.softwareName } data-toggle="tooltip" data-placement="top" title="" data-original-title="删除APP基础信息以及全部版本信息">删除</a></li>--%>
                      </ul>
                    </div>
										</td>
									</tr>
